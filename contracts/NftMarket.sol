...
contract NftMarket is ERC721URIStorage {
    ...
    function _beforeTokenTransfer(
        ...
        if(from == address(0)){
            ...
            _removeTokenToAllTokensEnumeration(from, tokenId);
        }
    ...
    // delete a token and move last token to position which deleted token was in
    function _removeTokenToAllTokensEnumeration(address from, uint tokenId) private {
